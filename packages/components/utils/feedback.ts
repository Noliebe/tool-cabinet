...
export class Feedback {
    ...
    // 确认窗体
    confirm(msg: string | VNode, title:string='温馨提示', type:MessageBoxState['type']='warning') {
    ...
    // 确认窗体
    alertConfirm(msg: string | VNode, title:string='温馨提示', options?:ElMessageBoxOptions) {
